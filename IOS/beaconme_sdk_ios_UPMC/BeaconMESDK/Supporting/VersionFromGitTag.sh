...
OLD_VERSION_DEFINE="^#define BEACON_ME_SDK_VERSION @\"*[0-9]\.*[0-9]\.[0-9]\""
NEW_VERSION_DEFINE="#define BEACON_ME_SDK_VERSION @\"${MARKETING_VERSION}\""

sed -i '' -e "s/${OLD_VERSION_DEFINE}/${NEW_VERSION_DEFINE}/" "${SRCROOT}/BeaconMESDK/BeaconMESDK.h"
